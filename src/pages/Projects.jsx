...
const Projects = () => {
  return (
    <section className="max-container text-white">
      ...
      <span className='blue-gradient_text font-semibold drop-shadow'> Projects</span> <br /></h1>
      <div className="mt-5 flex flex-col gap-3 text-slate-50">
        <p>I've build a number of web apps. Some are simple, some a bit complicated.</p>
      </div>
